...
def badge_invalide():
 sleep(0.01)# certaine fois ça place a cause d'une erreur sur les pins
 display.lcd_clear();
 display.lcd_display_string("Erreur : " , 1) # Affichage texte sur la 1ere ligne
 display.lcd_display_string("Badge invalide", 2) # Affichage texte sur la 2eme ligne
 
 
def reset_casier():
 sleep(0.01)# certaine fois ça place a cause d'une erreur sur les pins
 display.lcd_clear();
 display.lcd_display_string("Casier" , 1) # Affichage texte sur la 1ere ligne
 display.lcd_display_string("a zero", 2) # Affichage texte sur la 2eme ligne
 sleep(4)

def stockage_init():
 sleep(0.01)# certaine fois ça place a cause d'une erreur sur les pins
 display.lcd_clear();
 display.lcd_display_string("Initialisation " , 1) # Affichage texte sur la 1ere ligne
 display.lcd_display_string("Machine", 2) # Affichage texte sur la 2eme ligne
